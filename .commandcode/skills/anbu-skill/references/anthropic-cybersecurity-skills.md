...
│   ├── references/anthropic-cybersecurity-skills-references/anthropic-cybersecurity-skills-assets/assets/references/
│   │   ├── standards.md      # Framework mappings
│   │   └── workflows.md      # Technical procedures
│   ├── references/anthropic-cybersecurity-skills-assets/scripts/
│   │   └── *.py              # Helper scripts
│   └── references/anthropic-cybersecurity-skills-assets/assets/
        ...
        if os.path.exists(skill_path):
            with open(skill_path, 'r') as f:
                ...
                if content.startswith('---'):
                    ...
                    refs_path = f'skills/{skill_dir}/references/anthropic-cybersecurity-skills-references/anthropic-cybersecurity-skills-assets/assets/references/standards.md'
...
Many skills include helper scripts in `references/anthropic-cybersecurity-skills-assets/scripts/` directories:
...
def execute_skill_script(skill_name, script_name, **kwargs):
    ...
    script_path = f'skills/{skill_name}/references/anthropic-cybersecurity-skills-assets/scripts/{script_name}'
...
If a skill doesn't show framework mappings, check `references/anthropic-cybersecurity-skills-references/anthropic-cybersecurity-skills-assets/assets/references/standards.md`:

```python
def audit_framework_mappings(skill_name):
    """Check which framework mappings exist for a skill"""
    refs_path = f'skills/{skill_name}/references/anthropic-cybersecurity-skills-references/anthropic-cybersecurity-skills-assets/assets/references/standards.md'
    
    if not os.path.exists(refs_path):
        print(f"⚠️  No references/anthropic-cybersecurity-skills-references/anthropic-cybersecurity-skills-assets/assets/references/standards.md found")
        return
...
- **Helper scripts**: working Python scripts in `references/anthropic-cybersecurity-skills-assets/scripts/` directories
- **Framework standards**: complete mappings in `references/anthropic-cybersecurity-skills-references/anthropic-cybersecurity-skills-assets/assets/references/standards.md`
