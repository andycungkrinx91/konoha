...
Load `references/tailwind-v4-shadcn-refs/advanced-usage.md` for advanced patterns including:

- **Custom Colors**: Add semantic colors beyond default palette
- **v3 Migration**: See `references/tailwind-v4-shadcn-refs/migration-guide.md` for complete guide
...
For detailed patterns and component composition examples, load `references/tailwind-v4-shadcn-refs/advanced-usage.md`.
...
Load `references/tailwind-v4-shadcn-refs/plugins-reference.md` for complete documentation including Typography plugin (prose classes), Forms plugin, installation steps, and common plugin errors.
...
### Load `references/tailwind-v4-shadcn-refs/common-gotchas.md` when:
