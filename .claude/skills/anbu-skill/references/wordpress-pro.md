...
|-------|-----------|-----------|
| Theme Development | `references/wordpress-pro-references/wordpress-pro-assets/assets/references/theme-development.md` | Templates, hierarchy, child themes, FSE |
| Plugin Architecture | `references/wordpress-pro-references/wordpress-pro-assets/assets/references/plugin-architecture.md` | Structure, activation, settings API, updates |
| Gutenberg Blocks | `references/wordpress-pro-references/wordpress-pro-assets/assets/references/gutenberg-blocks.md` | Block dev, patterns, FSE, dynamic blocks |
| Hooks & Filters | `references/wordpress-pro-references/wordpress-pro-assets/assets/references/hooks-filters.md` | Actions, filters, custom hooks, priorities |
| Performance & Security | `references/wordpress-pro-references/wordpress-pro-assets/assets/references/performance-security.md` | Caching, optimization, hardening, backups |
...
function my_theme_assets(): void {
    ...
    wp_enqueue_script(
        'my-theme-script',
        get_template_directory_uri() . '/references/wordpress-pro-assets/assets/js/main.js',
        [ 'jquery' ],
        '1.0.0',
        true // load in footer
    );
...
- Enqueue references/wordpress-pro-assets/scripts/styles via `wp_enqueue_scripts` / `admin_enqueue_scripts` hooks
