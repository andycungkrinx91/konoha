...
|-------|-----------|-----------|
| GitHub Actions | `references/devops-engineer-references/devops-engineer-assets/assets/references/github-actions.md` | Setting up CI/CD pipelines, GitHub workflows |
| Docker | `references/devops-engineer-references/devops-engineer-assets/assets/references/docker-patterns.md` | Containerizing applications, writing Dockerfiles |
| Kubernetes | `references/devops-engineer-references/devops-engineer-assets/assets/references/kubernetes.md` | K8s deployments, services, ingress, pods |
| Terraform | `references/devops-engineer-references/devops-engineer-assets/assets/references/terraform-iac.md` | Infrastructure as code, AWS/GCP provisioning |
| Deployment | `references/devops-engineer-references/devops-engineer-assets/assets/references/deployment-strategies.md` | Blue-green, canary, rolling updates, rollback |
| Platform | `references/devops-engineer-references/devops-engineer-assets/assets/references/platform-engineering.md` | Self-service infra, developer portals, golden paths, Backstage |
| Release | `references/devops-engineer-references/devops-engineer-assets/assets/references/release-automation.md` | Artifact management, feature flags, multi-platform CI/CD |
| Incidents | `references/devops-engineer-references/devops-engineer-assets/assets/references/incident-response.md` | Production outages, on-call, MTTR, postmortems, runbooks |
