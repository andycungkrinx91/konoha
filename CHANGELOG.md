...
- **Full Test Suite & Cross-Client Parity**: All 64 JavaScript test suites pass cleanly (100% pass rate) across all 7 supported coding clients (Antigravity IDE/CLI, Cursor, Claude Code, OpenCode, Command Code, Codex, and Pi/pi.dev).
...
### Added: Direct Subagent Skill Embedding CLI & Interactive Workflow Demo (`bin/cli.js`, `src/skill_manager.js`, `src/agent_manager.js`, `scripts/generate_skill_embed_demo.py`)
...
- **Real 5-Step Workflow Recording & HD Demo Assets (`assets/demo-skill-embed.gif`, `assets/demo-skills.gif`)**: Created a dedicated demo generator (`scripts/generate_skill_embed_demo.py`) and recorded an authentic terminal GIF capturing the complete 5-step workflow: search -> add -> inspect -> embed -> migrate.
