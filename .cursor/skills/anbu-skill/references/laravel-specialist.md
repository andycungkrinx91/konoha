...
|-------|-----------|-----------|
| Eloquent ORM | `references/laravel-specialist-references/laravel-specialist-assets/assets/references/eloquent.md` | Models, relationships, scopes, query optimization |
| Routing & APIs | `references/laravel-specialist-references/laravel-specialist-assets/assets/references/routing.md` | Routes, controllers, middleware, API resources |
| Queue System | `references/laravel-specialist-references/laravel-specialist-assets/assets/references/queues.md` | Jobs, workers, Horizon, failed jobs, batching |
| Livewire | `references/laravel-specialist-references/laravel-specialist-assets/assets/references/livewire.md` | Components, wire:model, actions, real-time |
| Testing | `references/laravel-specialist-references/laravel-specialist-assets/assets/references/testing.md` | Feature tests, factories, mocking, Pest PHP |
