...
function setupSession(text, mtimeOffset = 7200) {
  const projectSlug = 'konoha-commandcode-attribution-test';
...
function main() {
  ...
  for (let idx = 0; idx < AGENTS.length; idx++) {
    ...
    const [convDir] = setupSession(text, 7200 + idx * 120);
    try {
